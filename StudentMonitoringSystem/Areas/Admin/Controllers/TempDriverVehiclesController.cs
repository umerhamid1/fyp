...
{
    public class TempDriverVehiclesController : Controller
    {
        private StudentsMonitringSystemEntities db = new StudentsMonitringSystemEntities();

        // GET: Admin/TempDriverVehicles
        ...
        // GET: Admin/TempDriverVehicles/Details/5
        ...
        // GET: Admin/TempDriverVehicles/Create
        public ActionResult Create()
        {
            ViewBag.DriverID = new SelectList(db.Drivers, "ID", "CampusID");
            return View();
        }

        // POST: Admin/TempDriverVehicles/Create
        ...
        // GET: Admin/TempDriverVehicles/Edit/5
        ...
        // POST: Admin/TempDriverVehicles/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/TempDriverVehicles/Delete/5
        ...
        // POST: Admin/TempDriverVehicles/Delete/5
